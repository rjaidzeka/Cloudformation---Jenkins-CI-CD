...
pipeline {
    ...
    stages {
        ...
        stage('Update Prod Stack') {
            steps {
            sh "aws cloudformation update-stack --stack-name s3bucket --template-body file://ventura-prod-env-infra.yaml --parameters file://ventura-infra-parametafile.json --region 'us-east-1'"
            }
        }
    ...
    post {
           always {
             ...
             slackSend channel: '#private-jenkins', //update and provide your channel name
